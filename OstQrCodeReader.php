...
namespace OstQrCodeReader;

use Shopware\Components\Plugin;
use Shopware\Components\Plugin\Context;
use Symfony\Component\DependencyInjection\ContainerBuilder;

class OstQrCodeReader extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_qr_code_reader.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_qr_code_reader.view_dir', $this->getPath() . '/Resources/views/');
